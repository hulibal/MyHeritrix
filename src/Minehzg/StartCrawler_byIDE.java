...
public class StartCrawler_byIDE {	
	...
	static CrawlStatusListener listener = null;// 监听器
	...
	public static void  main(String []args) throws InterruptedException {
		...
		try {
			File file = new File("E:/spider/job/order.xml"); // order.xml文件
			handler = new XMLSettingsHandler(file);
			handler.initialize();// 读取order.xml中的各个配置
			//
			CrawlController controller = new CrawlController(); // Heritrix的控制器
